...
export const generatePrompt = ({ theme, menu }: PromptOptions) => {
  ...
  const prompt = `
        Aku adalah seorang content creator untuk sebuah coffee shop. Tugasku membuat konten berupa foto dan video yang diunggah di akun Instagram coffee shop tempatku bekerja. Aku mengalami kesulitan dalam menentukan caption untuk setiap postingan Instagram setelah selesai membuat konten.

        Bantu aku membuat caption untuk postingan Instagram. Sesuaikan gaya bahasa, panjang kalimat, dan nada penulisan dengan caption-caption yang pernah aku buat sebelumnya, namun tetap menghasilkan sentuhan yang segar dan baru. Respon yang aku harapkan hanya berupa caption tanpa penjelasan tambahan.
        ...
        - Rasakan suasana tropis yang nyaman di Pour Indonesia.
        ...
        - Nasi ayam kalasan, rasa yang tak terkalahkan. Nikmati nasi ayam kalasan dengan rasa khas Jawa hanya di POUR INDONESIA.
        - Rasakan kesempurnaan rasa cemilan dan minuman yang bikin hari anda lebih bahagia!
        - Mencari sesuatu yang berbeda? Kunjungi POUR INDONESIA di lantai 2 untuk pengalaman bersantai yang indah.
        ...
        - Kami menyajikan yang terbaik untuk anda, nasi ayam sambal terasi khas POUR INDONESIA.
        - Puaskan keinginanmu akan sesuatu yang manis dan berbuih dengan soda berkilauan kami!
        - Rasakan layanan terbaik dari tim Pour Indonesia! Kami berdedikasi untuk menyediakan pelanggan tercinta kami dengan layanan luar biasa dan suasana yang hangat dan ramah.
        - Ubah momen-momen biasa menjadi kenangan luar biasa dengan minuman kami yang istimewa!

        Berikan aku satu caption baru yang memiliki gaya bahasa yang sama dengan contoh di atas, namun tetap menghasilkan sentuhan yang baru dan segar. ${additionalPrompt && `${additionalPrompt}. `} Tulis caption tanpa penjelasan tambahan.
      `
